...
public partial class CounterStatusBarView : UserControl, IDisposable
{
    ...
    public CounterStatusBarView(CounterViewModel viewModel, IViewFactory viewFactory)
    {
    ...
    private void ValueLabel_OnMouseLeftButtonDown(object sender, MouseButtonEventArgs e)
    {
        ...
        var numpad = _viewFactory.Create<NumpadView>(initialValue, false);
